...
class Constants {
    companion object{
        const val BASE_URL = "http://192.168.0.206:8084/api/"
        ...
        const val IP_ADDRESS_REQUEST_KEY = "IP_ADDRESS_REQUEST_KEY"
        const val IP_ADDRESS_ARG = "IP_ADDRESS_ARG"
        ...
        const val INVITE_POSTPONED_ARG = "INVITE_POSTPONED_ARG"
    }
}